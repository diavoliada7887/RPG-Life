const CACHE='rpg-life-v16-simple-daily-bank';
const ASSETS=['./','./index.html','./styles.css','./fantasy.css','./rpg-v2.css','./rpg-v4.css','./app.js','./calorie-bank.js','./rpg-simple-bank.js','./manifest.webmanifest','./icon.svg'];
