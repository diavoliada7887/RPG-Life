const CACHE='rpg-life-v14-creative-calorie-bank';
const ASSETS=['./','./index.html','./styles.css','./fantasy.css','./rpg-v2.css','./rpg-v4.css','./app.js','./manifest.webmanifest','./icon.svg'];
