const CACHE='rpg-life-v15-calorie-bank-remaining';
const ASSETS=['./','./index.html','./styles.css','./fantasy.css','./rpg-v2.css','./rpg-v4.css','./app.js','./calorie-bank.js','./manifest.webmanifest','./icon.svg'];
